...
In this case, the payload would execute the alert function, which creates a popup dialog that displays the information passed to the alert. The reference to document inside the parentheses is the DOM and, in this case, will return the domain name of the site. If the payload is executed on *https://www.sahilsinghrawat.com*, the popup box would display *www.sahilsinghrawat.com* Click on the button below to get that popup

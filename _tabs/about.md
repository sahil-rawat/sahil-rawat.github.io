...
order: 1
---
Hello! 👋🏻 I’m Sahil, a Software Developer at Morgan Stanley.

While I build robust software by day, I spend my spare time dismantling it to understand how it works under the hood. My passion lies at the intersection of Software Engineering and Cybersecurity, with a deep focus on Web Application Security, Red Teaming, and System Internals.

I believe that to write secure code, you must understand how to break it. This blog is my digital garden where I document my research, from high-level vulnerability analysis in Java and Python to low-level system exploitation.
